...
namespace BlueInt32.Core.StdResult
{
	public class StdResult<T>
	{
		...
		public static StdResult<T> BadResultFormat(string message, object arg0)
		{
			return new StdResult<T> { Result = false, Message = string.Format(message, arg0) };
		}
		#endregion
